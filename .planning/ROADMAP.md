...
- [x] **Phase 1: Shell & Boundary** - 建立 WebUI 外壳和与现有 Dexter 核心之间的适配边界 (completed 2026-05-05)
- [x] **Phase 2: Streaming Chat** - 让浏览器可以发起会话并接收流式回答 (completed 2026-05-05)
- [ ] **Phase 3: Run Transparency** - 展示工具调用、审批、运行控制和模型选择
- [x] **Phase 4: Sessions & Preferences** - 支持会话恢复、历史管理和本地偏好保存 (completed 2026-05-05)
- [x] **Phase 5: Polish & Parity** - 打磨响应式与键盘体验，并做兼容性回归防护 (completed 2026-05-05)
- [ ] **Phase 6: Integrate external research data sources** - 扩展研究数据路由和外部数据源接入
...
Plans:
- [ ] 01-01-PLAN.md — 搭建 WebUI 应用壳和基础路由
- [ ] 01-02-PLAN.md — 定义与现有 Dexter 核心交互的适配边界
- [ ] 01-03-PLAN.md — 验证 CLI / Gateway 与新外壳并存
...
Plans:
- [x] 02-01: 实现网页消息输入与会话启动
- [x] 02-02: 实现流式输出和中间状态渲染
...
|-------|----------------|--------|-----------|
| 1. Shell & Boundary | 3/3 | Complete   | 2026-05-05 |
| 2. Streaming Chat | 2/2 | Complete   | 2026-05-05 |
| 3. Run Transparency | 0/3 | Not started | - |
| 4. Sessions & Preferences | 2/2 | Complete    | 2026-05-05 |
| 5. Polish & Parity | 3/3 | Complete | 2026-05-05 |
| 6. Integrate external research data sources | 0/0 | Not started | - |

### Phase 6: Integrate external research data sources
